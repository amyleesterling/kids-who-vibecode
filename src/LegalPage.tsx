        ...
        <div className="page-shell legal-layout">
          ...
          <article className="legal-copy">
            ...
            <section id="privacy">
              ...
              <p>We keep aggregate numbers showing approximately how many browsing sessions have visited the public site and the countries those visits came from. Country is reduced immediately to a country-level total; we do not retain an IP address or a location attached to an individual visit. The counter does not use cookies or Google Analytics and does not record pages viewed, identity, device details, city or precise location, referrer, or form activity. A temporary session flag helps avoid counting the same open browser session repeatedly; the flag stays on the device and is not sent to us.</p>
              ...
              <p>Approved public fields are visible to anyone. Amy may invite trusted parent reviewers to help assess pending projects. Those reviewers receive only the child’s nickname and age group, project title and description, submitted image, project links, and automated safety-review summary; they do not receive the submitting adult’s name or email, subscriber information, or the private challenge calendar. Reviewer links can expire or be revoked, and reviewers leave advisory recommendations while Amy keeps the final publish or reject decision.</p>
              <p>Other private information is available only to authorized club administrators and service providers that help us host the site, store data and images, protect the service, or deliver requested email. These providers may process information only to provide those services. External project links have their own privacy practices.</p>
