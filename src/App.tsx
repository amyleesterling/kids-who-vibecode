...
function App() {
  ...
  return (
    <div id="top">
      ...
      <footer><div className="page-shell footer-layout"><Logo /><p>Vibe Code Kids was created by Amy Sterling, whose kids enjoy vibe coding and wanted to see what other kids were creating.</p><div><a href="/favorites">Clubhouse Favorites</a><a href="#subscribe">Weekly email</a><a href="/legal">Terms & Privacy</a><a href="https://x.com/amyneurons" target="_blank" rel="noreferrer">Contact on X</a><a href="#top">Back to top ↑</a></div></div><div className="footer-ticker"><span>MAKE SOMETHING WEIRD</span><i>✦</i><span>BREAK IT ON PURPOSE</span><i>✦</i><span>SHOW US WHAT YOU BUILT</span><i>✦</i></div></footer>
