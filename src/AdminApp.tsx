...
type Dashboard = {
  ...
  visitCountries: Array<{ countryCode: string; count: number }>
    ...
    <div className="admin-shell">
      ...
      <main className="admin-content">
        {tab === 'challenges' && <section>
          ...
          <div className="challenge-bank-heading"><div><span className="kicker">Private future shelf</span><h3>Future challenges</h3></div><p>Seven possibilities for later in the year—including a holiday challenge saved for December. Click any card to edit its full text.</p></div>
